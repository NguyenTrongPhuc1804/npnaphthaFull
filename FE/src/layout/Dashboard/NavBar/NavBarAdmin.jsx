        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <div
              ...
              } absolute top-[2rem] lg:right-[1rem] right-0 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700`}
              id="notification-dropdown"
            >
              <div className="block flex justify-between py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <p>Notifications</p>
                <Button
                  color="red"
